...
const AppointmentForm = () => {
  ...
  return (
    <div className="container mx-auto">
      <form onSubmit={handleSubmit} className="max-w-md  bg-gray-200 mx-10 p-8 rounded shadow-lg">
        ...
        <button type="submit" className="block mt-6 w-full rounded-md bg-red-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Submit</button>
      </form>
    </div>
  );
};

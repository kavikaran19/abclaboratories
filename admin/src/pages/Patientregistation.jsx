...
function PatientRegistration() {
    ...
    return (
            ...
            <div className="max-w-lg w-full bg-gray-500 rounded-lg shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button type="submit" className="w-full bg-red-500 text-white rounded-md px-3 py-2">Save</button>
                </form>
            </div>
        </div>

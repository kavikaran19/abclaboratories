...
const TestForm = () => {
  ...
  return (
    <div className="container mx-auto  ">
      <form onSubmit={handleSubmit} className="max-w-md  mx-10 bg-gray-300 p-[55px] rounded shadow-lg">
        <h2 className="text-4xl font-semibold text-center text-red-600 mb-[10px]">Test Form</h2>
        ...
        <button type="submit" className="block mt-8 w-full rounded-md bg-red-600 px-4 py-2 text-center text-sm font-semibold
         text-white hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Create Test</button>
      </form>
    </div>
  );
};

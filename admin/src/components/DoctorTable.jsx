...
const DoctorTable = () => {
  ...
  return (
    <div className="flex flex-col">
      <a href="/adddoctor">
      <button type="button" class="text-white bg-gradient-to-r bg-green-500 hover:bg-red-500 focus:ring-4 focus:outline-none  shadow-lg dark:shadow-lg  font-[5px] rounded-lg text-sm px-10 py-3 text-center me-2 mb-2">
Add doctor</button>

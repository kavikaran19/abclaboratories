...
const TechnicianTable = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <button type="button" class="text-white bg-green-500 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300
       dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg
       font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Add Technicians</button>
      </a>
